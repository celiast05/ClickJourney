...
function print_trip($list, $name) {
    if (!empty($list)) {
        ...
        foreach ($trips as $t) { // on fait la liste des correspondances
...
<script>
    ...
    function validateForm() {
        let requiredFields = document.querySelectorAll('.profil-info input[required], .profil-info select[required], .profil-info textarea[required]');
        let isValid = true;
